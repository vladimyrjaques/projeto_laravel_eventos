...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="/img/vjeventos.png">
    ...
    <body class="">
        <header>
            <a href="/" class="area-logo"><img class="area-logo" src="/img/vjeventos.png" alt=""></a>
                        ...
                        @auth
                            ...
                            <li class="nav-item">
                                <form action="/logout" method="post">
                                    @csrf
                                    <a class="nav-link active" aria-current="page" href="/logou" onclick="event.preventDefault();this.closest('form').submit();">Sair</a>
                                </form>
                            </li>
                        @endauth
                        @guest
        ...
        @if(session('msg'))
            <p class="msg-success">{{ session('msg') }}</p>
        @endif
        @yield('content')
    <footer>
        <p>VJ - Eventos</p>
